'''
"data" refers to the actual information you store in ObjectBox, while "lock" is a mechanism used by the database 
to ensure data consistency and prevent conflicts during concurrent access.
'''
...
def vector_embedding():
    if 'vectors' not in st.session_state:
        ...
        st.session_state.docs = st.session_state.loader.load()  ## Data Ingestion
...
input_prompt = st.text_input("Enter the question from document : ")
